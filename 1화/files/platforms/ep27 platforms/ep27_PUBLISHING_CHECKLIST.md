# EP27 — PUBLISHING CHECKLIST
# AI Fall Detection — Building a Safety Net for Parents Living Alone
...
|---|---|
| YouTube Long-form Script | sns/youtube/ep27_youtube_longform_script.md |
| YouTube Shorts Script | sns/youtube/ep27_youtube_shorts_script.md |
| All SNS Copy | sns/ep27_all_sns_copy.md |
| SubStack + WordPress | blogs/ep27_substack_and_wordpress.md |
| Image Prompts | images/prompts/ep27_image_generation_prompts.md |
| SEO Keywords | seo/ep27_seo_keywords.md |

---

*AI Decoded for Seniors Pipeline v1.0 | 2026-04-28*
